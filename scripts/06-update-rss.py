...
def main() -> None:
    ...
    fg.description("The latest inspections posted online by the U.S. Department of Agriculture's Animal and Plant Health Inspection Service")
    ...
    for row in reversed(feed_data):
        ...
        fe.description(f"""Critical: {row['web_critical']}
